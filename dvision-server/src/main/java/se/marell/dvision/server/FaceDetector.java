...
public class FaceDetector {
    ...
    private OpenCVFrameConverter.ToMat cvFrameConverter = new OpenCVFrameConverter.ToMat();
    ...
    public List<LabeledRectangle> getFaces(BufferedImage bImage) {
        Mat inputMat = cvFrameConverter.convert(new Java2DFrameConverter().convert(bImage));
        Mat matGray = new Mat();
