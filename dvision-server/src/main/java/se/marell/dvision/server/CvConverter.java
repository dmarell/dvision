...
public class CvConverter {
    ...
    private LocallyModifiedJava2DFrameConverter java2dConverter = new LocallyModifiedJava2DFrameConverter();

    public opencv_core.IplImage toIplImage(BufferedImage bufImage) {
        java2dConverter.resetState();
...
class LocallyModifiedJava2DFrameConverter extends FrameConverter<BufferedImage> {
    ...
    public void resetState() {
        if (frame != null && frame.opaque != null) {
            cvReleaseImage((opencv_core.IplImage) frame.opaque);
        }
        frame = null;
        bufferedImage = null;
    }
